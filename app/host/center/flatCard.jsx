...
import { MapPin, FileText, ExternalLink, Text, FileArchive } from 'lucide-react'
...
export const FlatCard = ({ flatData }) => {
	...
	const openDocumentsInNewTabs = () => {
		// Open each document in a new tab (must be from user-triggered event)
