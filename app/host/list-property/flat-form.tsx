...
export default function FlatForm() {
  ...
  return (
    <div className="max-w-screen-xl mx-auto bg-white shadow-xl rounded-2xl p-8 mt-10">
      ...
      <div className="mb-6">
        ...
        <div className="flex gap-4 mt-2">
          {["1 BHK", "2 BHK", "3 BHK"].map((type) => (
            <Button key={type} variant="outline" className="hover:bg-gray-100">
              {type}
            </Button>
          ))}
        </div>
      ...
      <div className="mb-6 space-y-4">
        <Label className="text-xl block font-semibold text-gray-700">
          Address
        </Label>
        <div>
        ...
        <div>
          <Label htmlFor="landmark">Nearby Location</Label>
