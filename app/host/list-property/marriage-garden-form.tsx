      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mb-1">
            Choose the category of garden property based on size and facilities.
          </p>
          <Select
            onValueChange={(value) =>
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mb-1">
            Enter Full address of the marriage garden.
          </p>
          <Textarea
            name="address"
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mb-1">
            Select additional amenities like AC, Parking, etc.
          </p>
          <Popover>
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mb-1">
            Enter the rental price for booking.
          </p>
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mb-1">
            Upload official property ownership documents (PDF/Images).
          </p>
          <Input
            type="file"
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mb-1">
           Enter the contact number of the garden manager/owner.
          </p>
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <div className="flex-1 min-w-[200px]">
            ...
            <p className="text-xs text-gray-500 mb-1">
              Certification proving fire safety measures.
            </p>
          ...
          <div className="flex-1 min-w-[200px]">
            ...
            <p className="text-xs text-gray-500 mb-1">
              Required if food services are provided on site.
            </p>
          ...
          <div className="flex-1 min-w-[200px]">
            ...
            <p className="text-xs text-gray-500 mb-1">
              Permission Certificate for organizing events.
            </p>
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mb-1">
              A short video showcasing the entire venue.
            </p>
            <Input
              type="file"
              name="mediaVideo"
