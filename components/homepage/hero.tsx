...
export default function Hero() {
	...
	const [propertyType, setPropertyType] = useState<'Apartment' | 'Individual' | 'Restaurant' | 'MarriageGarden'>('Apartment')
			...
			<div className="flex justify-between gap-4 relative">
				...
				<div className="max-w-[34ch] w-[34ch] min-w-[34ch] h-full">
					<p className="font-medium opacity-70 mt-4 tracking-tight leading-5">
						Discover your next home or investment with tailored listings, expert insights, and seamless experience.
					</p>

					<Link href="/listings" className="underline font-medium text-sm absolute bottom-0">
						Discover our Spotly
					</Link>
				</div>
			</div>
			...
			<div className="h-full mt-20 relative">
				...
				<div className="absolute top-0 left-0 w-full h-full flex justify-center items-center">
					<div className="w-full flex justify-center items-center flex-col gap-4">
						<h1 className="text-primary-foreground text-5xl font-medium text-center my-10">Discover a place you'll love</h1>
							...
							<div className="h-12 px-10 flex gap-4">
									...
									<div className="flex gap-4 items-center justify-center text-white h-full">
										<div
											className={cn(
												...
												active === 'Buy' && 'bg-primary-foreground text-blue-500'
											)}
										...
										<div
											className={cn(
												...
												active === 'Rent' && 'bg-primary-foreground text-blue-500'
											)}
								...
								<div className="h-full w-fit px-6">
									<div className="flex gap-8 font-medium items-center justify-center text-white h-full">
										<div className={'rounded-full py-1 relative hover:cursor-pointer'} onClick={() => setPropertyType('Apartment')}>
											Apartment
										...
										<div
											className={cn('rounded-full py-1 relative hover:cursor-pointer')}
