...
export default function Hero() {
	...
	const [propertyType, setPropertyType] = useState<'Flats' | 'Restaurant' | 'MarriageGarden'>('Flats')
							...
							<div className="h-12 px-10 flex gap-4">
								...
								<div className="h-full w-fit px-6">
									<div className="flex gap-8 font-medium items-center justify-center text-white h-full">
										<div className={'rounded-full py-1 relative hover:cursor-pointer'} onClick={() => setPropertyType('Flats')}>
											Apartment
											{propertyType === 'Flats' && (
