    ...
    <div className=" my-28 space-y-8">
      ...
      <div className="flex flex-col space-y-4  justify-center text-center items-center mb-8">
        ...
        <p className="text-lg text-gray-500 max-w-[35ch]">
          Highlight premium listings to draw attention to the best properties
          available.
        </p>
      </div>
      <div className="flex justify-center items-center">
        <Tabs defaultValue="account" className="">
          <TabsList className="p-6 rounded-2xl">
            <TabsTrigger
              className="rounded-2xl pl-0 p-4 data-[state=active]:bg-orange-600 data-[state=active]:text-white"
              value="jaipur"
            >
              Jaipur
            </TabsTrigger>
