  ...
  return (
    <Wrapper>
      <footer className="bg-white text-black ">
        {/* Hero Section */}
        <div className="relative w-full h-[600px] bg-black mx-auto rounded-3xl text-white">
          <Image
            width={360}
            quality={100}
            height={278}
        ...
        <div className=" mx-4 px-4 py-8 flex justify-between items-center gap-6">
          {/* Company Info */}
          <div className="max-w-[55ch]">
            <h2 className="text-2xl font-semibold">Spotly</h2>
            <p className="text-base mt-2 ">
              <span className="text-orange-500 font-medium">Spotly</span> is a
              leading platform for booking and managing properties, transforming
              the way people find and book spaces for living and celebrations
              through innovative design and technology. For buyers and sellers,
              we simplify the process by helping you find the right property,
              handling negotiations, and ensuring a smooth transaction. . From
              budget-friendly rentals to premium venues for events,{" "}
              <span className="text-orange-500 font-medium">Spotly</span> has
              something for everyone—your perfect space is just a step away.{" "}
              <br />
              <h2 className="mt-5">
                {" "}
                <span className="tetx-lg font-medium ">
                  {" "}
                  Popular Locations:
                </span>{" "}
                Jaipur | Delhi | Mumbai | Hyderabad | Pune | Noida | Gurugram |
                Bangalore | Indore | Thane
              </h2>
            </p>
